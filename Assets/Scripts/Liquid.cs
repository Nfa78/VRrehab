...
public class Liquid : MonoBehaviour
{
    ...
    public void SpillLiquid(float amount)
    {
        fillAmount = Mathf.Max(0, fillAmount - amount); // reduce fillAmount, prevent going below zero
        UpdatePos(Time.deltaTime); // update the visual to reflect the new fill level
    }
